...
public:
    ...
    ErrorCode mkdir(const std::string& path, int16_t uid, int16_t gid);

    ErrorCode open(const std::string& path, const std::string& mod, int16_t uid, int16_t gid, OpenFileHandler& fh);
